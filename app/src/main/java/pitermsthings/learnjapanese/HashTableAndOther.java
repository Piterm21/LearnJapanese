...
public class HashTableAndOther {
    ...
    private void fillTableForIToValue(int i, int maxValue) {
    ...
    private void SetUpTableRomaji() {
        ...
        fillTableForIToValue(SignZero%LowestValueChar, LastSign%LowestValueChar);
        fillTableForIToValue(SignZeroKatakana%LowestValueChar, LastSignKatakana%LowestValueChar);
    }
